...
const DEFAULT_ENRICHMENTS: Record<string, Array<{ type: string; order: number }>> = {
  donation_matching: [
    ...
    { type: "match_programme", order: 2 },
    { type: "ai_message", order: 3 },
  ],
  grant_research: [
    { type: "foundation_lookup", order: 0 },
    { type: "grant_programmes", order: 1 },
    { type: "eligibility_check", order: 2 },
    { type: "loi_generator", order: 3 },
  ],
  corporate_sponsorship: [
    { type: "company_research", order: 0 },
    { type: "csr_signals", order: 1 },
    { type: "contact_enrichment", order: 2 },
    { type: "proposal_generator", order: 3 },
  ],
  volunteer_matching: [
    { type: "company_research", order: 0 },
    { type: "volunteer_programme", order: 1 },
    { type: "coordinator_lookup", order: 2 },
    { type: "outreach_generator", order: 3 },
  ],
  in_kind_donation: [
    { type: "company_research", order: 0 },
    { type: "donation_programme", order: 1 },
    { type: "procurement_contact", order: 2 },
    { type: "request_generator", order: 3 },
  ],
};
